const memberData = [
  {
    ...
    bestPick: "CJ Stroud (2023, 1.04)",
    worstPick: "Trey Lance (2021, 1.01)",
    bestTrade: [
      "Lamar Jackson, 2026 1st, 2025 3rd",
      "Kenny Pickett, Keaton Mitchell, 2025 1st, 2026 1st",
      "Trade completed with Cole (December, 2023)",
    ],
    worstTrade: [
      "Stefon Diggs",
      "Kareem Hunt",
  ...
  },
  {
    ...
    bestPick: "Jalen Hurts (2020, 3.06)",
    worstPick: "Caleb Williams (2024, 1.01)",
    bestTrade: [
      "George Pickens, 2026 1st(Miah), 2025 2nd",
      "Jonathan Taylor",
      "Trade completed with Miah (August, 2023)",
    ],
    worstTrade: [
      "DK Metcalf, Derrius Guice, Sam Darnold, 2020 1st, 2021 1st, 2021 1st",
...

  {
    ...
    bestPick: "Justin Herbert (2020, 2.07)",
    worstPick: "Andrew Luck (2019 League Startup Draft, 4.06)",
    bestTrade: [
      "Justin Jefferson",
      "Tyler Boyd, Jonnu Smith, 2022 1st (Miah), 2022 2nd (Miah), 2022 3rd (Miah)",
      "Trade completed with Jesse (October, 2021)",
    ],
    worstTrade: [
      "Jared Goff, Leonard Fournette, 2023 2nd (Miah)",
      "Javonte Williams",
  ...
  },
  {
    ...
    name: "Carter",
    nickName: "Post-Prime",
    bestPick: "Jahmyr Gibbs (2023, 1.05)",
    worstPick: "Cam Akers (2020, 1.10)",
    bestTrade: [
      "Travis Kelce, Joe Burrow, David Johnson, Chris Herndon",
      "Ezekiel Elliot, Adam Thielen",
      "Trade completed with Cole (September, 2020)",
    ],
    worstTrade: [
      "Travis Kelce, 2023 1st, 2023 3rd",
  ...
  },
  {
    ...
    bestPick: "Jayden Reed (2023, 3.09)",
    worstPick: "Juju Smith-Shuster (2019 League Startup Draft, 1.10)",
    bestTrade: [
      "Mike Evans, Kenny Golladay, Chris Carson, 2022 1st",
      "Christian McCaffery, Terry McLaurin, 2021 2nd",
      "Trade completed with Miah (November, 2019)",
    ],
    worstTrade: [
      "Alvin Kamara, 2024 1st (Jacob)",
      "Bryce Young",
  ...
  },
  {
    ...
    worstPick: "",
    bestTrade: [
      "Gardner Minshew, 2025 1st, 2026 2nd, 2027 1st",
      "Jayden Reed",
      "Trade completed with Miah (October, 2024)",
    ],
    worstTrade: [
      "Alvin Kamara, 2024 1st (Jacob)",
      "Bryce Young",
  ...
  },
  {
    ...
    bestPick: "Ceedee Lamb (2020, 1.03)",
    worstPick: "Jonathan Mingo (2023, 2.03)",
    bestTrade: [
      "2020 1st(Ceedee Lamb - 1.03), 2020 2nd(Josh)",
      "Julio Jones, 2020 1st(5th overall), 2021 2nd, 2023 3rd",
      "Trade completed with Josh (August, 2020)",
    ],
    worstTrade: [
      "Cameron Brate, Tyler Lockett, 2021 1st (Jose), 2022 1st (Jose), 2021 2nd (Jose), 2022 2nd (Jose), 2021 3rd (Jose), 2022 3rd (Jose)",
      "Zach Ertz",
  ...
  },
  {
    ...
    bestPick: "Justin Jefferson (2021, 1.07)",
    worstPick: "Skyy Moore (2022, 1.07)",
    bestTrade: [
      "Jared Goff, Leonard Fournette, 2023 2nd(Miah)",
      "Javonte Williams",
      "Trade completed with Miah (October, 2022)",
    ],
    worstTrade: [
      "Justin Jefferson",
      "Tyler Boyd, Jonnu Smith, 2022 1st (Miah), 2022 2nd (Miah), 2022 3rd (Miah)",
  ...
  },
  {
    ...
    bestPick: "Amon-Ra St. Brown (2021, 2.06)",
    worstPick: "Clyde Edwards-Helaire (2020, 1.01)",
    bestTrade: [
      "Stefon Diggs",
      "Kareem Hunt",
      "Trade completed with Bow (August, 2020)",
    ],
    worstTrade: [
      "Kyler Murray",
  ...
  },
  {
    ...
    bestPick: "Ja'Marr Chase (2021, 1.05)",
    worstPick: "David Johnson (2019 League Startup, 2.09)",
    bestTrade: [
      "DK Metcalf, Derrius Guice, Sam Darnold, 2020 1st, 2021 1st, 2021 1st",
      "David Johnson, Carson Wentz",
      "Trade completed with Cole (October, 2019)",
    ],
    worstTrade: [
      "Brock Purdy, 2023 3rd",
      "Cam Akers, 2025 2nd",
  ...
  },
  {
    ...
    bestPick: "Breece Hall (2022, 1.01)",
    worstPick: "Odell Beckham Jr. (2019 League Startup, 1.07)",
    bestTrade: [
      "Cameron Brate, Tyler Lockett, 2021 1st(Jose), 2022 1st(Jose), 2021 2nd(Jose), 2022 2nd(Jose), 2021 3rd(Jose), 2022 3rd(Jose)",
      "Zach Ertz",
      "Trade completed with Jose (November, 2019)",
    ],
    worstTrade: [
      "2020 1st (Ceedee Lamb - 1.03), 2020 2nd (Josh)",
